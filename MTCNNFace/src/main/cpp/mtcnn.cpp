...
MTCNN::MTCNN(const string &model_path) {
    ...
    int ret1 = Pnet.load_param(param_files[0].data());
    int ret2 = Pnet.load_model(bin_files[0].data());
    int ret3 = Rnet.load_param(param_files[1].data());
    int ret4 = Rnet.load_model(bin_files[1].data());
    int ret5 = Onet.load_param(param_files[2].data());
    int ret6 = Onet.load_model(bin_files[2].data());
