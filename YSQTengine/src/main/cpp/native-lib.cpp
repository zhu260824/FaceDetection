...
Java_com_zl_tengine_TengineTest_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_zl_tengine_TengineTest_TengineWrapperInit(
        JNIEnv *env,
        jobject /* this */) {
...
JNIEXPORT jint JNICALL
Java_com_zl_tengine_TengineTest_TengineWrapperRelease(
        JNIEnv *env,
        jobject /* this */) {
...
JNIEXPORT jint JNICALL
Java_com_zl_tengine_TengineTest_RunMobilenetFromFile(
        JNIEnv *env,
...
JNIEXPORT jint JNICALL
Java_com_zl_tengine_TengineTest_RunMobilenet(
        JNIEnv *env,
...
JNIEXPORT jstring JNICALL
Java_com_zl_tengine_TengineTest_TengineWrapperGetTop1(
        JNIEnv *env,
        jobject /* this */) {
